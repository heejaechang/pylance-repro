...
These candidate failures are tracked in the separate follow-up issue:
https://github.com/microsoft/pylance-release/issues/8200.
Its canonical standalone workspace is [pylance-issues/8200](../8200).

The retained [complete-expressions](complete-expressions) workspace
